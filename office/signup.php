              ...
              <div class="col-lg-8">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><span><strong>SWAY AG-3K</strong></span><br> Quick Sign Up</h1>
                  </div>
                  <form class="user" method="POST" id="signup_form">
                    ...
                    <!-- <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="customCheck"><a href="#">I agree to terms and conditions</a></label>
                      </div>
                    </div> -->
