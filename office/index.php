              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><span><strong>SWAY AG-3K</strong></span><br> Welcomes You Back</h1>
                  </div>
                  <form class="user" method="POST" id="login_form">
                    ...
                    <a href="" class="btn btn-sm btn-primary btn-user btn-block" id="cmd_login">
                     ...
                     <a href="password_reset" class="text-center"  >
                      <!-- class="btn btn-sm btn-google btn-user btn-block" -->
                      <i class="fa fa-keyw"></i> Reset Password
                    </a>
                    <hr>
