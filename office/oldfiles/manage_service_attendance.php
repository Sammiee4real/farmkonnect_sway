      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Services Attendance(ALL)
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Manage Services Attendance(ALL)</h6>
              <p class="mb-4">You can log attendance of members present in services here(ALL) etc</p>
