      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View Home Cell Attendance</h1>
        ...
        <div class="row">          
              ...
              <h6 class="m-0 font-weight-bold text-primary">View Home Cell Attendance</h6>
              <p class="mb-4">You can view all logged attendance per home cell/all home cell here</p>
