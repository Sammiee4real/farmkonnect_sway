<?php require_once('config/instantiated_files.php');
       ...
       $users = get_rows_from_one_table_with_sql_param($param,'outreach_members',$conditions,'date_created');
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Send SMS to Outreach Members</h1>
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Send SMS to Outreach Members</h6>
              <p class="mb-4">You can send sms to Outreach Members</p>
              ...
              <form method="post" id="outreach_sms_form" enctype="multipart/form-data" class="user" action="">
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    <label>Select Member(s) to send to: </label>                                
                ...
                <input type="submit" value="Send SMS" id="cmd_send_outreach_sms"  name="cmd_send_outreach_sms" class="btn btn-primary btn-sm btn-block"/>
                </a>
