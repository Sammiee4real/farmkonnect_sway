      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Library/Store: HardCopy Books</h1>
        ...
        <div class="row">
              ...
              <div class="col-md-10">
                ...
                echo $msg;
                 ...
                 <a href="add_hardcopy_books.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Add New HardCopy Book</a>
                </div>
                </div><br>
              <h6 class="m-0 font-weight-bold text-primary">View Added HardCopy books</h6>
