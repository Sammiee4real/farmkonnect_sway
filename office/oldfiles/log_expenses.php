      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Log Expenses</h1>
        ...
        <div class="row">  
              ...
              <h6 class="m-0 font-weight-bold text-primary">Log EXPENSES</h6>
              <p class="mb-4">You can log expenses here</p>
          ...
          <!-- <div class="col-lg-5 d-none d-lg-block bg-register-image"></div> -->
            ...
            <div class="p-3">
              ...
              <form method="post" id="log_acct_entries_form"  class="user" action="">
                         ...
                         <input type="hidden" required="" id="transaction_type" value="debit" class="form-control form-control-sm col-5" name="transaction_type">

                   <!-- <a href="#" id="add_expense_entries" class="btn btn-primary btn-sm">+add expense entries</a> -->
                     <a href="" id="add_expense_entries"  class="btn btn-primary btn-sm"><i class="fa fa-history" aria-hidden="true"></i> add expenses</a>
              ...
              <tfoot>
                <th colspan="3"><input type="submit" value="Submit Expense Entries" class="btn btn-primary cmd_class_entries" name="cmd_entries" id="cmd_entries"></th>
                <th></th>
