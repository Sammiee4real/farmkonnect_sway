      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Birthdays</h1>
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">View Birthday Celebrants</h6>
              <p class="mb-4">View Today's Celebrants</p>

            <div class="card shadow mb-4">



                          <?php  members_search_by_birthday();?>
