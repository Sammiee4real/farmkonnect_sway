...
<body id="page-top">
 ...
 -->
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">All Accounting Entries</h6>
              <p class="mb-4">You can view all Accounting Entries Here</p>
            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                      ...
                      <table id="accounting_entries_tbl" class="table table-bordered display " style="width:100%">
                      <thead>
                      <tr>
                      <th>Action</th>
                      <th>Item Name</th>
