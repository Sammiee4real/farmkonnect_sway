      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Send SMS to some Members</h1>
        ...
        <div class="row">
              ...
              <h6 class="m-0 font-weight-bold text-primary">Send SMS to some Members</h6>
              <p class="mb-4">You can send sms to some Members</p>
              ...
              <form method="post" id="custom_sms_form" enctype="multipart/form-data" class="user" action="">
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select style="width: 100%;"  required="" class="js-example-basic-multiple2" multiple="multiple" name="mem_number_list[]" id="mem_number_list">
                         ...
                         <?php
                          ...
                          <option  value="<?php echo $mem_det['unique_id']; ?>"><?php echo $members_info; ?></option>
                ...
                <input type="submit" value="Send SMS" id="cmd_send_custom_sms"  name="cmd_send_custom_sms" class="btn btn-primary btn-sm btn-block"/>
                </a>
