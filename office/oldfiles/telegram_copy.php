<?php   require_once("config/validations.php");
       ...
       elseif($chatStatus['status'] === "get_phone" && strtolower($currentMessage) != 'hello'){
     ...
     elseif($chatStatus['status'] === "get_bvn" && strtolower($currentMessage) != 'hello'){
      ...
      elseif($chatStatus['status'] === "get_email" && strtolower($currentMessage) != 'hello'){
     ...
     elseif($chatStatus['status'] === "get_account_no" && strtolower($currentMessage) != 'hello'){
     ...
     elseif($chatStatus['status'] === "confirm_user_details"  && $currentMessage == '1'){
      ...
      ///enter otp
    elseif($chatStatus['status'] === "get_otp"  && strtolower($currentMessage) !== 'hello'){
     ...
     elseif($chatStatus['status'] === "started" && $currentMessage == '3' ){
       ...
       if($chatStatus['status'] === "get_phone_4_loan_status"  && strtolower($currentMessage) != 'hello'){
         ...
         //contact us
         elseif(   $chatStatus['status'] === "started"  &&  $currentMessage == '5'){
        ...
        //FAQs
        elseif(   $chatStatus['status'] === "started"  &&  $currentMessage == '6'){
