        ...
        <div class="row">
              ...
              <div class="col-md-10">
                ...
                echo $msg;
                 ...
                 <a href="add_ebooks.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Add New Ebook</a>
                </div>
                </div><br>
              <h6 class="m-0 font-weight-bold text-primary">View Added E-books</h6>
              <p class="mb-4">You can view all added ebook materials in the church here</p>

              <div class="card shadow mb-4">
              <!-- <hr> -->
              <div class="row">
                  <div class="col-lg-12 p-3">
                    <h6 class="m-3 font-weight-bold text-default">View All Ebooks</h6>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo date('F-d-Y',strtotime($ebook['date_added'])); ?></td>
